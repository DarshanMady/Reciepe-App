...
public class RequestManager {
    ...
    public void getSimilarRecipes(SimilarRecipesListener listener,int id){
        CallSimalarRecipes callSimalarRecipes=retrofit.create(CallSimalarRecipes.class);
        Call<List<SimilarRecipeResponse>> call=callSimalarRecipes.callSimilarRecipe(id,"4", context.getString(R.string.api_key));
    ...
    private interface CallSimalarRecipes{
